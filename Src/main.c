/**
  *******************************************************************************************
  * @file    LL/I2C/I2C_OneBoard_Communication_IT_Init/Src/main.c
  * @author  Karanveer Singh
  * @brief   In this code Master device receives multiple bytes from slave
  * 		 device over i2c using STM32F4xx I2C LL API in interrupt mode.This code is based
  * 		 upon I2C_OneBoard_Communication_ example code.
  *
  *******************************************************************************************
  * @attention
  *
...
/**
  ...
  */
uint8_t      aReceiveBuffer[aReceiveBufferSize];
...
void Slave_Ready_To_Transmit_Callback(void)
{
  ...
  LL_I2C_TransmitData8(I2C1, SLAVE_BYTE_TO_SEND[aReceiveBufferSize - ubNbDataToTransmit]);
}
...
void Master_Complete_Callback(void)
{
  ...
  if(ubNbDataToReceive == 0)
  {
    ...
    if(aCompareBuffer(SLAVE_BYTE_TO_SEND, aReceiveBuffer,aReceiveBufferSize))
    {
      /* Turn LED2 On:
